...
void main()
{
    ...
    vec3 result = calcpointlight(plight,normal,viewDir,fragPos,material);
//     calcdirlight(dlight,normal,viewDir,material)
...
vec3 calcpointlight(Pointlight light,vec3 normal,vec3 viewDir,vec3 fragPos,Material material){
    ...
    vec3 specular = vec3(1.0f) * spec * plight.specular;
